...
class StaticDefaultCamera : public Camera
{
public:
	StaticDefaultCamera(XMFLOAT3 camera_position, FLOAT yaw, FLOAT pitch, FLOAT roll) : _Camera_Position(camera_position), _Yaw(yaw), _Pitch(pitch), _Roll(roll)
	{
		InitialiseView();
